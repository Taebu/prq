...
class Mobile_m extends CI_Model
{
	 ...
	 * @return array
	 */
    function get_list($table='bbd_talktalkclick_pc_log', $type='', $offset='', $limit='', $search_word='')
    {

		$sword= ' WHERE 1=1 ';
		if($table==""){
		$table='bbd_talktalkclick_pc_log';
		}
		if ( $search_word != '' )
     	{
     		//검색어가 있을 경우의 처리
...
//		$table="ci_board";
		...
		$sql = "SELECT * FROM ".$table." ".$sword."  ORDER BY bt_no DESC".$limit_query;
