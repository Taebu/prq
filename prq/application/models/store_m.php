...
*/
		...
		$sql_array[]="st_tel_2='".$arrays['st_tel_2']."',";
		$sql_array[]="st_tel_3='".$arrays['st_tel_3']."',";
		$sql_array[]="st_tel_4='".$arrays['st_tel_4']."',";
		$sql_array[]="st_hp_1='".$arrays['st_hp_1']."',";
		$sql_array[]="st_hp_2='".$arrays['st_hp_2']."',";
		$sql_array[]="st_hp_3='".$arrays['st_hp_3']."',";
		$sql_array[]="st_hp_4='".$arrays['st_hp_4']."',";
