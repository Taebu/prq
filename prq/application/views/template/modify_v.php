...
echo form_open(sprintf('/template/modify/%s/bp_no/%s',$method,$bt_no), $attributes);
...
{
	$is_match=$app->bp_appid==$views->appid;
	printf($is_match?"<option value='%s' selected>%s</option>":"<option value='%s'>%s</option>",$app->bp_appid,$app->bp_plusid);
}?></select>
...
<div class="col-sm-10">
<input type="hidden" name="bt_plusid" id="bt_plusid" value="<?php echo $views->bt_plusid;?>">
<span class="bt_plusid"><?php echo $views->bt_plusid;?></span>
...
<div class="col-sm-10"><input type="text" class="form-control" id="bt_code" name="bt_code" value="<?php echo $views->bt_code;?>"> <span class="help-block m-b-none text-danger" id="mb_name_assist">*주의 선택 기재사항이지만 센더키가 없으면 알림톡이 발송되지 않습니다. </span>
</div><!-- .col-sm-10 -->
</div><!-- .form-group -->
<div class="hr-line-dashed"></div><!-- .hr-line-dashed -->
...
<div class="col-sm-10">
<textarea name="bt_content" id="bt_content" cols="30" rows="10"  class="form-control"><?php echo $views->bt_content;?></textarea>
</div><!-- .col-sm-10 -->
</div><!-- .form-group -->
<div class="hr-line-dashed"></div><!-- .hr-line-dashed -->

<div class="form-group"><label class="col-sm-2 control-label">정규식 코드</label>
<div class="col-sm-10" id="regex_area"><?php echo chg_template_rule($views->bt_regex,"add");?></div><!-- .col-sm-10 #regex_area-->
</div><!-- .form-group -->
<div class="hr-line-dashed"></div><!-- .hr-line-dashed -->

<div class="form-group"><label class="col-sm-2 control-label">템플릿 상세내용 </label>
<div class="col-sm-10">
<input type="text" class="form-control" id="bt_comment" name="bt_comment" value="<?php echo $views->bt_comment;?>">
</div><!-- .col-sm-10 -->
</div><!-- .form-group -->
<div class="hr-line-dashed"></div><!-- .hr-line-dashed -->
<div class="controls">
...
$( "#mb_id" ).focusout(function() {
	...
	$('input:radio[name=bt_type]:input[value=<?php echo $views->bt_type;?>]').attr("checked", true);
//
	/*mb_code로 등록 정보 변경*/
	//chg_gname();
};/*window.onload = function() {..}*/
