...
var code_key="";
	$.ajax({
	url:"/prq/ajax/get_codes/"+$("#mb_no").val(),
	type: "POST",
	data:"",
	dataType:"json",
	success: function(data) {
			$.each(data.codes,function(key,val){
				...
				if($("#code_"+code_key).attr("type")=="text"){
				$("#code_"+code_key).val(val);
				}
			});
		}
	});
...
<div class="form-group"><label class="col-sm-2 control-label">POS명 <br>(code : 4005) <br>prq_member.pos_name</label>
<div class="col-sm-10"><input type="text" class="form-control" name="code_4005" id="code_4005" value="" placeholder="해당 가맹점의 POS를 기입해주세요." onkeyup="javascript:set_values(this.value,'4005');" onkeydown="javascript:set_values(this.value,'4005');">
<span class="help-block m-b-none text-danger font-bold">해당 가맹점의 POS를 기입해주세요.</span>
</div><!-- .col-sm-10 -->
