...
/**
* 네이버 테이블 가맹점 등록 페이지
* file : /prq/application/views/franchise/naver/write_v.php
* 작성 : 2019-12-09 10:58:49 (월요일)
* 수정 : 
*
* @author Moon Taebu
* @Copyright (c) 2019, 태부
...
<!-- 	<div class="col-sm-10"><select name="prq_fcode"  class="form-control" id="prq_fcode" size='10'></select> -->
	<div class="col-sm-10"><select name="prq_fcode"  class="form-control select2_demo_1" id="prq_fcode"  ></select>
