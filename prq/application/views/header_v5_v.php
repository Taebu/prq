					...
					<?php 
					 ...
					 ?>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <!-- <?php echo $this->uri->segment(3)=="prq_ata_pay"?'<li class="active">':'<li>';?><a href="/prq/partner/lists/prq_ata_pay/page/1">알림톡 입금 목록 <span class="label label-primary pull-right">NEW</span></a></li> -->
                        </ul>
                    </li>
                    </li>
					<?php 
...
<!-- 					<?php 
	...
	<a href="#"><i class="fa fa-files-o"></i><span class="nav-label">Appjoin</span><span class="fa arrow"></span></a>
	<ul class="nav nav-second-level collapse">
	...
	<?php echo $this->uri->segment(1)=="template"?'<li class="active">':'<li>';?><a href="/prq/template/lists/template">템플릿관리<span class="label label-primary pull-right">NEW</span></a></li>
	...
	</ul><!-- <ul class="nav metismenu" id="side-menu"> -->
            </div>
        </nav>
					...
					<?php 
					 echo $this->uri->segment(1)=="partner"?'<li class="active">':'<li>';?>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="/prq/partner/lists/prq_ata_pay/page/1">알림톡 입금 목록</a></li>
                        </ul>
                    </li>
                    </li>
					<?php 
