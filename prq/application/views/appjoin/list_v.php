...
/**
* 상점 리스트 뷰 페이지
* file : /prq/application/views/appjoin/list_v.php
* 작성 : 2017-05-29 (월) 9:43:33 
* 수정 : 
*
* @author Moon Taebu
* @Copyright (c) 2016, 태부
...
//					var act = '/prq/store/lists/ci_board/q/'+$("#q").val()+'/page/1';
		...
		function set_write(){
		$('#bd_search').attr('action', "/prq/appjoin/write/modu_agreement/page/1");
          $("#bd_search").submit();		
...
<button type="button" class="btn btn-sm btn-warning" onclick="chg_list('ca');">설치실패</button>
<button type="button" class="btn btn-sm btn-free" onclick="chg_list('fr');">무료</button>
</div><!-- .btn_area -->
<?php }?>
...
?>
	...
	<tr>
		<td scope="col"><input type="checkbox" name="chk_seq[]" value="<?php echo $lt->ma_no;?>" onclick="chk_btn_status()"></td>
		<td><?php echo $lt->st_name;?> 
		<span id="ttno_<?php echo $lt->st_ceoname;?>"></span></td>
		<td><a rel="external" href="/prq/<?php echo $this->uri->segment(1);?>/view/modu_agreement/board_id/<?php echo $lt->ma_no;?>/page/<?php echo $page;?>"><?php echo $lt->ma_datetime;?></a></td>
		<td><a rel="external" href="/prq/<?php echo $this->uri->segment(1);?>/pview/modu_agreement/board_id/<?php echo $lt->ma_no;?>/page/<?php echo $page;?>">출력버전으로보기</a></td>
	</tr>
<?php
}
