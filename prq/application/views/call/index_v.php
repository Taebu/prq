            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="include/img/a4.jpg">
                                </a>
                                <div class="media-body ">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="include/img/profile.jpg">
                                </a>
                                <div class="media-body ">
                ...
                <div class="row  border-bottom white-bg dashboard-header">
					...
					<?php
						if( @$this->session->userdata['logged_in'] == TRUE )
					{?>
                        <h2>환영합니다. "<?php echo $this->session->userdata['name'];?>"님</h2>
						<?php }else{?>
                        <h2>로그인 해주세요.</h2>
						<?php }?>
                        ...
                        <ul class="list-group clear-list m-t">
                            <?php
							$i=0;
							foreach($message_list as $mlt){
							?>
							<li class="list-group-item fist-item">
                                <span class="pull-right">
                                   <?php echo $mlt['utime'];?>
                                </span> 
                                <span class="label label-<?php echo $mlt['status'];?>"><?php echo ++$i?></span> <?php echo $mlt['content'];?>
                            </li>
							<?php }?>
                        </ul>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div>
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="include/img/a2.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="include/img/a3.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="include/img/a5.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
