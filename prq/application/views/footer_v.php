    ...
    <!-- Peity -->
    <script src="/prq/include/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/prq/include/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="/prq/include/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="/prq/include/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="/prq/include/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/prq/include/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="/prq/include/js/plugins/chartJs/Chart.min.js"></script>
