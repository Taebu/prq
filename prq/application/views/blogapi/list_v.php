...
<tr>
	...
	<th scope="col">네이버아이디</th>
	<th scope="col">네이버비밀번호</th>
	<th scope="col">핸드폰</th>
	<th scope="col">상태</th>
	<th scope="col">날짜</th>
</tr>
...
?>
<tr>
<td><?php echo $lt->pb_no;?></td>
<td><?php echo $lt->pb_company_name;?></td>
<td><?php echo $lt->pb_app_name;?></td>
<td><?php echo $lt->pb_naver_id;?></td>
<td><?php echo $lt->pb_naver_pw;?></td>
<td><?php echo $lt->pb_hp;?></td>
<td><?php echo $lt->pb_status;?></td>
<td><?php echo $lt->pb_datetime;?></td>
</tr>
<tr>
<td>Access_token<br>Refresh_token</td>
<td colspan="7"><?php echo $lt->access_token;?><br><?php echo $lt->refresh_token;?></td>
</tr>
<!-- <tr>
