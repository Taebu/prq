...
(
    [0] => stdClass Object
        (
            [st_no] => 442
            [prq_fcode] => DS0001PT0002FR0068
            [mb_id] => 0314873300@naver.com
            [st_category] => W07
            [st_name] => 한가족장충동족발보쌈 월피점
            [st_tel] => 0314873300
            [st_open] => 
            [st_closed] => 
            [st_alltime] => on
            [st_intro] => 최고의맛과 서비스로 보답드리겠습니다.
            [st_nick_date] => 0000-00-00
            [st_email] => 
            [st_homepage] => 
            [st_business_name] => 
            [st_business_paper] => store_1483600176.jpg
            [st_business_paper_size] => 167955
            [st_thumb_paper] => store_1483600165.jpg
            [st_thumb_paper_size] => 33698
            [st_menu_paper] => store_1483600156.png
            [st_menu_paper_size] => 634725
            [st_main_paper] => 
            [st_main_paper_size] => 0
            [st_modoo_url] => 
            [st_top_msg] => (광고) [ 한가족장충동족발보쌈 월피점 ] 에서
            [st_middle_msg] => 최고의 맛과 서비스로\n보답하겠습니다.			...
            [st_bottom_msg] => 
            [st_business_num] => 
            [st_datetime] => 2017-01-05 16:10:09
            [st_status] => wa
            [st_cidtype] => ktcid
            [st_tel_1] => 03148733300
            [st_hp_1] => 01053850677
            [st_port] => 1
            [st_mno] => SK
            [st_theme] => red
            [st_vtel] => 0508-5196-0234
            [st_teltype] => cashq
        )
*/

$st_origin = json_decode(json_encode($st_origin), True);
echo $st_origin[2]['pv_no'];
...
- 		<td scope="row"><?php echo $lt->st_no;?></td>
		<td scope="row"><?php echo $index;echo $index>-1?'e':'u';?></td>
		<td scope="row"><?php echo strlen($st_origin[$index]['pv_value']);?></td>
...
<button type="button" class="btn btn-sm btn-danger" onclick="chg_list('ad');">승인거부</button>
<button type="button" class="btn btn-sm btn-info" onclick="chg_list('ec');">1,2개 미흡</button>
<button type="button" class="btn btn-sm btn-warning" onclick="chg_list('ca');">설치실패aaaaaaa</button>
</div><!-- .btn_area -->
<?php }?>
</div>
</div>
