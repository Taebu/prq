                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>SMS LOG 현황 입니다. <small>콜 정보를 조회해 주세요.</small></h5>
    ...
    <div class='row'>
        <div class='col-sm-6'>    
            <div class='form-group'>
                <label for="sm_receiver">수신자(sm_receiver)</label>
                <input class="form-control" id="sm_receiver" name="sm_receiver" size="30" type="text" value="<?php echo set_value($search['sm_receiver'],"");?>"/>
            </div><!-- .form-group -->
        </div><!-- .col-sm-6 -->
        <div class='col-sm-6'>
            <div class='form-group'>
                <label for="sm_sender">발신자(sm_sender)</label>
                <input class="form-control" id="sm_sender" name="sm_sender" size="30" type="text" value="<?php echo $search['sm_sender'];?>"/>
            </div><!-- .form-group -->
        </div><!-- .col-sm-6 -->
    </div><!-- .row -->
    <div class='row'>
        <div class='col-sm-6'>    
            <div class='form-group'>
                <label for="sm_content">내용</label>
                <input class="form-control" id="sm_content" name="sm_content" size="30" type="text" value="<?php echo $search['sm_content'];?>"/>
            </div><!-- .form-group -->
        </div><!-- .col-sm-6 -->
        <div class='col-sm-6'>
            <div class='form-group'>
