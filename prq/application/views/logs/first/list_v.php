<?php
 /***********************************
 *
 * /prq/application/views/logs/first/list_v.php
 * 
 ***********************************
  * string_format
 ***********************************/
                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>FIRST LOG 현황 입니다. <small>콜 정보를 조회해 주세요.</small></h5>
...
<th scope="col">포트</th>
<th scope="col">상점명</th>
<th scope="col">상점전화</th>
<th scope="col">손님전화</th>
<th scope="col">*상태</th>
</tr>
</thead>
<tbody>
...
if(count($list)==0){
?>
<tr><td scope="row" colspan='11' class='text-center'> 조회한 FIRST Log가 없습니다.</td></tr>
<?php
}
foreach ($list as $lt)
{
?>
<tr>
<td scope="row"><?php echo $lt->pf_no;?></td>
<td scope="row"><?php echo $lt->pf_datetime;?></td>
<td scope="row"><?php echo $lt->pf_id;?></td>
<td scope="row"><?php echo $lt->pf_port;?></td>
<td scope="row"><?php echo $lt->pf_name;?></td>
<td scope="row"><?php echo phone_format($lt->pf_tel);?></td>
<td scope="row"><?php echo phone_format($lt->pf_hp);?></td>
<td scope="row"><?php echo $lt->pf_status;?></td>
</tr>
<?php
}
?>
