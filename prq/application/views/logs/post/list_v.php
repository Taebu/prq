 ...
 ?>
	<script>
		$(document).ready(function(){
			$("#search_btn").click(function(){
				if($("#q").val() == ''){
					...
					var act = '/prq/logs/lists/post/q/'+$("#q").val()+'/page/1';
		...
		function search_form(p,type){
			$("#page").val(p);
			if(type=="search"){
			var act = '/prq/logs/lists/post/q/'+$("#gc_receiver").val()+'/page/'+p;
			}else{
			var act = '/prq/logs/lists/post/page/'+p;
			}
			$("#bd_search").attr('action', act).submit();
		}
                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>POST LOG 현황 입니다. <small>포스팅 정보를 조회해 주세요.</small></h5>
		...
		<table cellspacing="0" cellpadding="0" class="table table-striped">
			<thead>
				<tr>
					...
					<th scope="col">메세지</th>
					<th scope="col">블로그url</th>
					<th scope="col">아이디</th>
					<th scope="col">category</th>
					<th scope="col">상점번호</th>
					<th scope="col">블로그번호</th>
					<th scope="col">로그입력일</th>
					</tr>
			</thead>
			<tbody>
<?php
...
?>
				<tr>
					<td scope="row" colspan='11' class='text-center'> 조회한 post Log가 없습니다.</td>
				</tr>
<?php
}
...
?>
				<tr>
					<td scope="row"><?php echo $lt->po_subject;?></td>
					<td scope="row"><?php echo $lt->po_status;?></td>
					<td scope="row"><?php echo $lt->na_code;?></td>
					<td scope="row"><?php echo $lt->na_http;?></td>
					<td scope="row"><?php echo $lt->na_message;?></td>
					<td scope="row"><?php echo $lt->bl_url;?></td>
					<td scope="row"><?php echo $lt->bl_naver_id;?></td>
					<td scope="row"><?php echo $lt->bl_category;?></td>
					<td scope="row"><?php echo $lt->st_no;?></td>
					<td scope="row"><?php echo $lt->bl_no;?></td>
					<td scope="row"><?php echo $lt->po_datetime;?></td>
				</tr>
<?php
}
?>
