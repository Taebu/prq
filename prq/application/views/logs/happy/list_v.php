                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>MMS LOG 현황 입니다. <small>콜 정보를 조회해 주세요.</small></h5>
		...
		<table cellspacing="0" cellpadding="0" class="table table-striped">
			<thead>
				<tr>
					...
					<th scope="col">해피콜 상태</th>
					<th scope="col">수신인</th>
					</tr>
			</thead>
			<tbody>
<?php
$is_list=count($list)>0;
/*리스트가 없으면 없는 값 출력*/
if(count($list)==0){
?>
				<tr>
					<td scope="row" colspan='11' class='text-center'> 조회한 happycall Log가 없습니다.</td>
				</tr>
<?php
}
if($is_list)
