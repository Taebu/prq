...
<div class="col-sm-10"><input type="text" class="form-control" id="bp_appid" name="bp_appid"> <span class="help-block m-b-none" id="mb_id_assist">앱아이디를 등록 합니다. 중복 된 앱아이디를 등록할 수 없습니다.</span>
</div><!-- .col-sm-10 -->
</div><!-- .form-group -->
...
<input type="radio" name="bp_status" id="bp_status_1" value='access' checked><label for="bp_status_1"><span class="btn btn-xs btn-success">정상</span></label>
</div><!-- .radio .radio-info .radio-inline -->

<div class="radio radio-warning radio-inline">
<input type="radio" name="bp_status" id="bp_status_2" value='stop'><label for="bp_status_2"><span class="btn btn-xs btn-warning">중지</span></label>
</div><!-- .radio .radio-info .radio-inline -->

<div class="radio radio-danger radio-inline">
<input type="radio" name="bp_status" id="bp_status_3" value='terminate'><label for="bp_status_3"><span class="btn btn-xs btn-danger">해지</span></label>
</div><!-- .radio .radio-info .radio-inline -->
