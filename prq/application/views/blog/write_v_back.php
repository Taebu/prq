							...
							<div class="form-group" style="margin-top:15px;"><!-- <label class="col-sm-2 control-label">핸드폰(필수)</label> -->
								...
								<div class="form-group" style="margin-top:-10px;">
									<div class="col-sm-10 col-sm-offset-2">
										<button type="button" class="btn btn-primary btn-block" onclick="set_ds();set_member()" id="write_btn" style="background:#10cdf4;border:0px solid #05c2e9;font-size:16px;font-weight:bold;">리뷰 등록</button>
