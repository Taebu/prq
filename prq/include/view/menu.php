<div class="contents" id="cMenu">
		...
		-->
<?php $me_src=$_POST['st_menu_paper'];?>
		<p class="btn_menu_zoom">
						<a href="/prq/include/view/menu_zoom.php?me_src=<?php echo $me_src;?>" target="blank"><img src="/prq/img/btn_menu_zoom_01.png" width="50px" border="0" alt="">
						</a>
					</p>
