<div class="contents" id="cInfo" ng-controller="infoCtrl">
	...
	<div id="storedetail_area">
		...
		<span class="thumb" style="background:url(http://prq.co.kr/prq/upload/TH/<?php echo $_POST['st_thumb_paper'];?>) center center no-repeat; background-size:100% 100%;">매장썸네일</span>
			<dl class="store_info">
				<dt><span class="user_photo_b">전화번호</span></dt>
				<dd><?php echo $_POST['st_tel'];?></dd>
				<dt>주문방법</dt>
				<dd>배달/포장 가능</dd>
		        <dt class="spac">휴 무 일</dt>
		        <dd>연중무휴</dd>
		        <dt>영업시간</dt>
		                        <dd><?php echo $_POST['st_alltime']=="on"?"24시간영업점":$_POST['st_open']." ~ ".$_POST['st_closed'];?></dd>
                		        <dt>결제방법</dt>
		        <dd>현금/카드 가능</dd>
      		</dl>
	  		<dl class="store_introduce clearfix">
	  			<dt>배달지역</dt>
	  			<dd><?php echo $_POST['st_destination'];?></dd>
	  			<dt>매장소개</dt>
	  			<dd><?php echo $_POST['st_intro'];?></dd>
      		</dl>
    	</div>
  	</div>
  	<!-- //storedetail -->
